...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey(UserProfile, on_delete=models.DO_NOTHING, verbose_name='用户')
    order_sn = models.CharField(max_length=13, unique=True, verbose_name='订单号')
    trade_no = models.CharField(max_length=13, unique=True, verbose_name='外部交易号')
    pay_status = models.CharField(max_length=32, choices=PAY_STATUS, verbose_name='支付状态')
    ...
    pay_time = models.DateTimeField(verbose_name='订单时间')
...
class OrderGoods(BaseModel):
    """订单中商品的信息"""
    order = models.ForeignKey(OrderInfo, on_delete=models.DO_NOTHING, verbose_name="订单信息", related_name="goods")
    goods = models.ForeignKey(Goods, on_delete=models.DO_NOTHING, verbose_name="商品")
    goods_num = models.IntegerField(verbose_name="商品数量")
